...
namespace AWSTools.Test
{
    ...
    public class S3
    {
        ...
        {
            AWSTools.CONFIG.SetConfig("", "", Amazon.RegionEndpoint.APSoutheast2);
        ...
        {
            AWSTools.CONFIG.SetConfig("", "", Amazon.RegionEndpoint.APSoutheast2);
            Amazon.S3.Model.GetObjectMetadataResponse response = AWSTools.S3.GetObjectMetadataResponse("aws-tools-testing", "forrest.jpg");
